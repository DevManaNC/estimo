  ...
  return (
    <>
      ...
      <div style={si.card}><div style={{ padding: 16 }}>
        ...
        <div style={si.row}>
          <div style={{ flex: 1 }}><div style={si.label}>Charges copro /an</div><input type="number" style={si.input} value={info.chargesCopro || ""} onChange={e => updateInfo("chargesCopro", +e.target.value || 0)} placeholder="0" /></div>
          <div style={{ flex: 1 }}><div style={si.label}>Frais gestion (%)</div><input type="number" style={si.input} value={info.fraisGestion || ""} onChange={e => updateInfo("fraisGestion", +e.target.value || 0)} placeholder="7" /></div>
        </div>
        <div style={si.row}>
          <div style={{ flex: 1 }}><div style={si.label}>Taux vacance (%)</div><input type="number" style={si.input} value={info.tauxVacance || ""} onChange={e => updateInfo("tauxVacance", +e.target.value || 0)} placeholder="5" /></div>
          <div style={{ flex: 1 }}><div style={si.label}>Assurance GLI /an</div><input type="number" style={si.input} value={info.assuranceGLI || ""} onChange={e => updateInfo("assuranceGLI", +e.target.value || 0)} placeholder="0" /></div>
        </div>
        {calc.chargesAn > 0 && (
